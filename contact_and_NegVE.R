###################################################################### #
#                                                                       #                                                   #
#     Contact Heterogeneity and Negative Vaccine Effectiveness          #
#                           Korryn Bodner                               #
#                                                                       #
########################################################################
...
#OUTPUTS: 
#EXTRA DETAILS: VE_S and VE_I to be 0.1, 0.5, 0.9
...
###FIGURE 1 (c and d) CONTOUR PLOTS (VES with VEI and contact heterogeneity.)

VeT.contour.df<-read.csv("VES_and_VEI.csv", )
contact.VES.df<-read.csv("VES_and_ContactIncrease.csv")
...
#Exploring Vaccine Effectiveness crossover in heterogeneous case (with low VEs)
...
ve.all01[c("time","susc.diff", "RR.overall")]
ve.01.05[c("time","susc.diff", "RR.overall")]
