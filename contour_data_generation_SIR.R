...
#               SIR Model Sensitivity Analyses (for Supp Mat)           #
#                                                                       #
########################################################################
...
##DATA GENERATION FOR SUPPLEMENTARY WEB FIGURE 4
#SENSITIVITY ANALYSES USING AN SIR MODEL
...
#Generating scenarios using an SIR model (can take a while to run)
...
#Generating scenarios (can take a while to run) using an SIR model
